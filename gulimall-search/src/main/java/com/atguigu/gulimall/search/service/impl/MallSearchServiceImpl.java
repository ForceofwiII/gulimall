...
public class MallSearchServiceImpl  implements MallSearchService {
    ...
    private SearchRequest buildSerchRequest(SearchParam param){
        ...
        if(!StringUtils.isEmpty(param.getSort())){
            ...
            sourceBuilder.sort(strings[0],strings[1].equalsIgnoreCase("asc")? SortOrder.ASC:SortOrder.DESC);
    ...
    private SearchResult buildSearchResult(SearchResponse  response , SearchParam param) {
        ...
        //获取属性信息的聚合
        //聚合返回类型可以都用terms
        //terms对象的getbuckets获得bucket集合
        //bucket里面在用getaggreation获得子聚合的terms对象
